...
export const NAVIGATING_TABS = 'app/NAVIGATING_TABS';
export const NAVIGATING_OPEN_VIEWS = 'app/NAVIGATING_OPEN_VIEWS';
export const NAVIGATING_MENU = 'app/NAVIGATING_MENU';
